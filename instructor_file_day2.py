...
# Modules are pieces of code that you import into your own code to extend the functionality of the Python language
# Various modules exist for all sorts of things, from web scraping, to game frameworks, to machine learning

# In this case, we've imported two modules -- one that will allow us to easily manipulate CSV files
# and another that allows us to scrape data from web pages
import csv
